...
public class GameResourceBundle implements ResourceBundleInterface {
    ...
    public void load() {
        ...
        this.TEXTURE_BOX0_DARK = Texture.fromImage(Image.loadFromEngineAssets("images/box0_dark.png"));
        this.MATERIAL_BOX0_DARK = new Material(this.TEXTURE_BOX0_DARK);
        this.TEXTURE_BOX1_DARK = Texture.fromImage(Image.loadFromEngineAssets("images/box1_dark.png"));
        this.MATERIAL_BOX1_DARK = new Material(this.TEXTURE_BOX1_DARK);
        this.TEXTURE_BOX2_DARK = Texture.fromImage(Image.loadFromEngineAssets("images/box2_dark.png"));
        this.MATERIAL_BOX2_DARK = new Material(this.TEXTURE_BOX2_DARK);
        this.TEXTURE_BOX3_DARK = Texture.fromImage(Image.loadFromEngineAssets("images/box3_dark.png"));
        this.MATERIAL_BOX3_DARK = new Material(this.TEXTURE_BOX3_DARK);
        this.TEXTURE_BOX4_DARK = Texture.fromImage(Image.loadFromEngineAssets("images/box4_dark.png"));
        this.MATERIAL_BOX4_DARK = new Material(this.TEXTURE_BOX4_DARK);
        this.TEXTURE_BOX5_DARK = Texture.fromImage(Image.loadFromEngineAssets("images/box5_dark.png"));
        this.MATERIAL_BOX5_DARK = new Material(this.TEXTURE_BOX5_DARK);
        this.TEXTURE_BOX6_DARK = Texture.fromImage(Image.loadFromEngineAssets("images/box6_dark.png"));
        this.MATERIAL_BOX6_DARK = new Material(this.TEXTURE_BOX6_DARK);
        this.TEXTURE_BOX7_DARK = Texture.fromImage(Image.loadFromEngineAssets("images/box7_dark.png"));
        this.MATERIAL_BOX7_DARK = new Material(this.TEXTURE_BOX7_DARK);
        this.TEXTURE_BOX8_DARK = Texture.fromImage(Image.loadFromEngineAssets("images/box8_dark.png"));
        this.MATERIAL_BOX8_DARK = new Material(this.TEXTURE_BOX8_DARK);
        this.TEXTURE_BOX9_DARK = Texture.fromImage(Image.loadFromEngineAssets("images/box9_dark.png"));
        this.MATERIAL_BOX9_DARK = new Material(this.TEXTURE_BOX9_DARK);
        this.TEXTURE_BOX10_DARK = Texture.fromImage(Image.loadFromEngineAssets("images/box10_dark.png"));
